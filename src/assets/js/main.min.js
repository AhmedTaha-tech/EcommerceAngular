...
$.extend($.easing, {
    ...
    (function (t) {
        ...
        (Wolmart.$window = t(window)),
            ...
            (Wolmart.initCartAction2 = function (e) {
                Wolmart.$body
                    .on("click", e, function (e) {
                        t(".cart-dropdown.notification-panel").addClass("opened"), e.preventDefault();
                    })
                    .on("click", ".cart-offcanvas2 .cart-overlay", function (e) {
                        t(".cart-dropdown.notification-panel").removeClass("opened"), e.preventDefault();
                    })
                    .on("click", ".cart-offcanvas2 .cart-header, .cart-close", function (e) {
                        t(".cart-dropdown.notification-panel").removeClass("opened"), e.preventDefault();
                    });
            }),
            (Wolmart.initCartAction3 = function (e) {
                Wolmart.$body
                   .on("click", e, function (e) {
                        t(".cart-dropdown.mobile-profile-panel").addClass("opened"), e.preventDefault();
                    })
                    .on("click", ".cart-offcanvas3 .cart-overlay", function (e) {
                        t(".cart-dropdown.mobile-profile-panel").removeClass("opened"), e.preventDefault();
                    })
                    .on("click", ".cart-offcanvas3 .cart-header, .cart-close", function (e) {
                        t(".cart-dropdown.mobile-profile-panel").removeClass("opened"), e.preventDefault();
                    });
            }),
                    ...
                    (function () {
                        ...
                        a.length ||
                            ...
                            (t(".page-wrapper").append(
                                '<div class="compare-popup">                    <div class="container-fluid">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
                            ),
                            (a = t(".page-wrapper > .compare-popup"))),
                            Wolmart.$body
    ...
    (Wolmart.init = function () {
        Wolmart.appearAnimate(".appear-animate"),
            ...
            Wolmart.initCartAction2(".cart-offcanvas2 .cart-toggle"),
            Wolmart.initCartAction3(".cart-offcanvas3 .cart-toggle"),
